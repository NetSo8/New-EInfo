...
## Produit
Site vitrine d'Elian, freelance IT à Rivesaltes (Pyrénées-Orientales). Le site doit
vendre aujourd'hui du dépannage et de l'infrastructure TPE/PME, tout en rendant
visible, sans la surjouer, une trajectoire vers l'architecture en cryptographie
système et cloud chiffré.

## Utilisateurs
1. **Particulier** : 35-70 ans, poste lent, imprimante morte, boîte mail piratée.
   Consulte souvent au téléphone, en extérieur, dans l'urgence. Ne lit pas le jargon.
   Veut : un numéro, un délai, un prix, quelqu'un du coin.
...
- Le cyberpunk néon sur noir : Matrix, circuits électroniques luisants, cadenas 3D.
- L'agence web générique : "solutions innovantes", "votre partenaire digital".
- Le site de sécurité anxiogène : cadenas, boucliers, chiffres de cyberattaques.
